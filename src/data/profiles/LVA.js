...
export default {
  ...
  "legalSystemOverview": {
    ...
    "description": "ラトビアはEU加盟国（2004年加盟）であり、Regulation (EU) 2017/745（MDR）および Regulation (EU) 2017/746（IVDR）が直接適用される。国内補完法として Ārstniecībā un farmācijā lietojamo medicīnisko ierīču likums（医療機器法）の改正版が施行されている。ZVA（Zāļu valsts aģentūra / 国家医薬品庁）がNCAとして医療機器の市場監視・ビジランスを管轄する。",
    "keyCharacteristics": [
      "EU MDR/IVDR が直接適用",
  ...
  "authorities": [
    {
      ...
      "localName": "Zāļu valsts aģentūra",
      "role": "NCA: 医療機器の市場監視・ビジランス・臨床試験監督・登録管理",
      "url": "https://www.zva.gov.lv/",
      "isPrimary": true
    },
    {
      "name": "VM",
      "fullName": "Ministry of Health",
      "localName": "Veselības ministrija",
      "role": "医療機器政策立案・法整備",
      "url": "https://www.vm.gov.lv/",
      "isPrimary": false
    },
    {
      "name": "NVD",
      "fullName": "National Health Service",
      "localName": "Nacionālais veselības dienests",
      "role": "公的医療サービス・償還管理",
  ...
  "implementingRegulations": [
    {
      "title": "Medicīnisko ierīču likums（医療機器法）改正",
      "date": "2021",
      "url": "https://likumi.lv/",
    ...
    {
      "title": "MK noteikumi（閣僚会議規則）— 各種施行細則",
      "date": "各年",
      "url": "https://likumi.lv/",
  ...
  "relatedLaws": [
    {
      ...
      "relevance": "健康データに適用。Fizisko personu datu apstrādes likums も併存。"
    },
    {
  ...
  "electronicSubmission": {
    "system": "EUDAMED + ZVA 国内登録",
    "url": "https://www.zva.gov.lv/",
    "description": "EUDAMED + ZVA 事業者登録。EUDAMED 4モジュール義務化: 2026年5月28日。",
    "mandatory": true
  },
  "udi": {
    "required": true,
  ...
  "postMarket": {
    "adverseEventReporting": {
      "system": "EU Vigilance System — ZVA",
      "mandatory": true,
      "url": "https://www.zva.gov.lv/",
      "description": "重篤有害事象をZVAに報告義務。MDR Article 87-92。"
    },
    "recalls": {
      "authority": "ZVA",
      "description": "FSCA/FSNはZVAに通知。ZVAが市場からの回収命令権限を有する。",
      "url": "https://www.zva.gov.lv/"
    },
  ...
  "certificateOfFreeSale": {
    "available": true,
    "issuingAuthority": "ZVA",
    "name": "Certificate of Free Sale (CFS)",
    "description": "ZVA がCFSを発行。",
    "processingTime": "要確認",
    "url": "https://www.zva.gov.lv/"
  },
  "reimbursement": {
