...
export default {
  ...
  "authorities": [
    {
      "name": "VVKT",
      "fullName": "State Medicines Control Agency",
      "localName": "Valstybinė vaistų kontrolės tarnyba",
      "role": "NCA: 医療機器の市場監視・ビジランス・臨床試験監督・登録管理",
      "url": "https://www.vvkt.lt/",
      "isPrimary": true
    },
    {
      "name": "SAM",
      "fullName": "Ministry of Health of the Republic of Lithuania",
      "localName": "Lietuvos Respublikos sveikatos apsaugos ministerija",
      "role": "医療機器政策立案・法整備",
    ...
    },
    {
      ...
      "localName": "Valstybinė ligonių kasa",
      "role": "公的医療保険・償還管理",
  ...
  "implementingRegulations": [
    {
      "title": "Lietuvos Respublikos medicinos priemonių įstatymas（医療機器法）改正",
      "date": "2021",
  ...
  "relatedLaws": [
    {
      ...
      "relevance": "健康データに適用。Asmens duomenų teisinės apsaugos įstatymas も併存。"
    },
    {
  ...
  "electronicSubmission": {
    "system": "EUDAMED + VVKT 国内登録",
    "url": "https://www.vvkt.lt/",
    "description": "EUDAMED + VVKT 事業者登録。EUDAMED 4モジュール義務化: 2026年5月28日。",
    "mandatory": true
  },
  "udi": {
    "required": true,
  ...
  "postMarket": {
    "adverseEventReporting": {
      "system": "EU Vigilance System — VVKT",
      "mandatory": true,
      "url": "https://www.vvkt.lt/",
      "description": "重篤有害事象をVVKTに報告義務。MDR Article 87-92。"
    },
    "recalls": {
      "authority": "VVKT",
      "description": "FSCA/FSNはVVKTに通知。VVKTが市場からの回収命令権限を有する。",
      "url": "https://www.vvkt.lt/"
    },
  ...
  "certificateOfFreeSale": {
    "available": true,
    "issuingAuthority": "VVKT",
    "name": "Certificate of Free Sale (CFS)",
    "description": "VVKT がCFSを発行。",
    "processingTime": "要確認",
    "url": "https://www.vvkt.lt/"
  },
  "reimbursement": {
