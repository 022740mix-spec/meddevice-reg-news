...
export default {
  ...
  "legalSystemOverview": {
    ...
    "description": "アルメニアでは保健省傘下のSCDMTE（医薬品・医療技術専門センター）が医療機器の輸入審査・専門評価を管轄。基本法はLaw No. ZR-42（1996年）「住民への医療援助およびサービスに関する法律」第10章。EAEU（ユーラシア経済連合）加盟国として4クラス分類（1/2a/2b/3）に整合。アルメニアは独自の国内登録制度を持たず、輸入許可制（GD 429-N/2023）で運用中。2025年12月31日まで国内規則での新規申請受付が可能。既存の国内登録は2026年12月31日まで有効。2027年1月1日以降はEAEU統一登録に完全一本化予定。",
    "keyCharacteristics": [
      "保健省 + SCDMTE（CJSC）がNCA",
      "Law No. ZR-42 (1996)「住民への医療援助およびサービスに関する法律」第10章が基本法",
      "EAEU整合の4クラス制（1/2a/2b/3）",
      "国内登録制度なし — 輸入許可制（GD 429-N/2023）で運用",
      "2025-12-31まで国内規則での新規申請受付可。既存の国内登録は2026-12-31まで有効。2027-01-01以降EAEU統一登録に完全一本化予定",
  ...
  "authorities": [
    {
      ...
      "localName": "Научный центр экспертизы лекарств и медицинских технологий им. академика Э. Габриеляна (НЦЭЛМТ)",
      "role": "NCA: 医療機器の輸入審査・専門評価・品質安全性評価・市販後監視。保健省傘下のCJSC（閉鎖型株式会社）。1992年設立。GD 1795-N（2022年）により医療機器の規制権限を付与。",
  ...
  "classification": {
    ...
    "rules": [
      ...
      "2025-12-31まで国内規則での新規申請受付可。既存国内登録は2026-12-31まで有効。2027-01-01以降EAEU統一登録に完全移行予定"
    ],
    "totalProductCodes": null
  },
  "conformityAssessment": {
    "overview": "二本立ての制度: (A) 国内輸入許可制（MoH/SCDMTE、GD 429-N/2023に基づく）、(B) EAEU統一登録（無期限有効、EAEU全5カ国で有効）。アルメニアは独自の国内登録制度を持たず、輸入許可制で運用中。2025年12月31日まで国内規則での新規申請受付が可能。既存の国内登録は2026年12月31日まで有効。2027年1月1日以降はEAEU統一登録に完全一本化予定。",
    "routes": [
      {
  ...
  "udi": {
    ...
    "timeline": "EAEU統一登録完全移行（2027年以降）に合わせて導入予定"
  },
  "postMarket": {
  ...
  "recentDevelopments": [
    ...
    },
    {
      ...
      "description": "EAEU改正議定書署名。加盟国が国内規則に基づく新規医療機器申請を2025年12月31日まで継続可能に。当初の2022年末期限から延長。既存の国内登録は2026年12月31日まで有効。2027年1月1日以降はEAEU統一登録に完全移行予定。"
    },
    {
      "date": "2024-07-18",
