...
export default {
  ...
  "legalSystemOverview": {
    ...
    "description": "ナイジェリアの医療機器規制はNAFDAC（National Agency for Food and Drug Administration and Control）が管轄する。2024年に新たなMedical Device Regulations 2024が制定され、規制枠組みが大幅に刷新された。GHTF/IMDRFの4クラス分類（Class A/B/C/D）を採用し、NAPAMS電子申請システムによるオンライン申請を導入。",
    "keyCharacteristics": [
      "NAFDACによる一元的な連邦規制体制",
  ...
  "deviceDefinition": {
    "legalDefinition": "Medical Device Regulations 2024に定義。疾病の診断・治療・予防・監視・軽減等を目的とする機器・装置・器具・材料・ソフトウェア等で、主たる意図する作用が薬理学的・免疫学的・代謝的手段によらないもの。GHTF/IMDRF定義に準拠。",
  ...
  "implementingRegulations": [
    {
      ...
      "date": "2024",
      "url": "https://www.nafdac.gov.ng/",
      "description": "医療機器の登録・分類・市販後監視・ラベリング等の詳細を規定する主要な施行規則。2024年に制定された最新の規制枠組み。",
      "category": "医療機器"
    }
  ],
  "relatedLaws": [],
  ...
  "conformityAssessment": {
    "overview": "全クラスの医療機器にNAFDAC登録が必要。NAPAMS（NAFDAC Automated Product Administration and Monitoring System）電子申請システム経由でオンライン申請。標準審査期間は120営業日。先行認可国（CE/FDA等）の承認書類を参考にした審査を実施。",
    "routes": [
      {
        ...
        "description": "NAPAMS経由の標準的な登録審査。技術文書・臨床評価・品質管理文書・CFS等を提出。審査期間は120営業日。",
        "subtypes": [],
  ...
  "electronicSubmission": {
    ...
    "url": "https://www.nafdac.gov.ng/",
    "description": "NAPAMSは NAFDACの統合電子申請システム。全ての医療機器登録申請はNAPAMS経由でオンライン提出。",
    "mandatory": true
  },
  "udi": {
    "required": false,
    "system": "未導入（検討段階）",
    "description": "ナイジェリアではUDI制度は現時点で未導入。Medical Device Regulations 2024で将来的な導入の基盤が整備された。",
    "url": null,
    "timeline": "未定"
  },
  "postMarket": {
    "adverseEventReporting": {
      ...
      "mandatory": true,
      "url": "https://www.nafdac.gov.ng/",
      "description": "製造業者・輸入業者・医療従事者は有害事象をNAFDACに報告する義務がある。Medical Device Regulations 2024で報告要件が強化。"
    },
    "recalls": {
      "authority": "NAFDAC",
    ...
    "surveillance": "Medical Device Regulations 2024に基づく市販後監視要件。PMS報告書の提出義務が規定。"
  },
  ...
  "recentDevelopments": [
    {
      ...
      "description": "NAFDACが新たなMedical Device Regulations 2024を制定。4クラス分類・NAPAMS電子申請・市販後監視の強化等を導入し、規制枠組みを国際基準に整合。"
    }
  ],
