...
export default {
  ...
  "legalSystemOverview": {
    ...
    "description": "クロアチアはEU加盟国（2013年加盟）であり、Regulation (EU) 2017/745（MDR）および Regulation (EU) 2017/746（IVDR）が直接適用される。国内補完法として Zakon o medicinskim proizvodima（医療機器法）の改正版が施行されている。HALMED（Agency for Medicinal Products and Medical Devices of Croatia / Agencija za lijekove i medicinske proizvode）がNCAとして市場監視・ビジランスを管轄する。",
    "keyCharacteristics": [
      "EU MDR/IVDR が直接適用",
  ...
  "authorities": [
    {
      "name": "HALMED",
      "fullName": "Agency for Medicinal Products and Medical Devices of Croatia",
      "localName": "Agencija za lijekove i medicinske proizvode",
      "role": "NCA: 医療機器の市場監視・ビジランス・臨床試験監督・登録管理",
      "url": "https://www.halmed.hr/en/Medicinski-proizvodi/",
      "isPrimary": true
    },
    {
      "name": "HZZO",
      "fullName": "Croatian Health Insurance Fund",
      "localName": "Hrvatski zavod za zdravstveno osiguranje",
      "role": "医療保険償還管理",
    ...
    },
    {
      ...
      "localName": "Ministarstvo zdravstva",
      "role": "医療機器政策立案・法整備",
  ...
  "implementingRegulations": [
    {
      "title": "Zakon o medicinskim proizvodima（医療機器法）改正",
      "date": "2021",
      "url": "https://www.halmed.hr/en/Medicinski-proizvodi/",
  ...
  "relatedLaws": [
    {
      ...
      "relevance": "健康データに適用。Zakon o provedbi Opće uredbe o zaštiti podataka も併存。"
    },
    {
  ...
  "electronicSubmission": {
    "system": "EUDAMED + HALMED 国内登録",
    "url": "https://www.halmed.hr/",
    "description": "EUDAMED + HALMED 事業者登録。EUDAMED 4モジュール義務化: 2026年5月28日。",
    "mandatory": true
  },
  "udi": {
    "required": true,
  ...
  "postMarket": {
    "adverseEventReporting": {
      "system": "EU Vigilance System — HALMED",
      "mandatory": true,
      "url": "https://www.halmed.hr/en/Medicinski-proizvodi/Vigilancija/",
      "description": "重篤有害事象をHALMEDに報告義務。MDR Article 87-92。"
    },
    "recalls": {
      "authority": "HALMED",
      "description": "FSCA/FSNはHALMEDに通知。HALMEDが市場からの回収命令権限を有する。",
      "url": "https://www.halmed.hr/"
    },
  ...
  "certificateOfFreeSale": {
    "available": true,
    "issuingAuthority": "HALMED",
    "name": "Certificate of Free Sale (CFS)",
    "description": "HALMED がCFSを発行。",
    "processingTime": "要確認",
    "url": "https://www.halmed.hr/"
  },
  "reimbursement": {
  ...
  "recentDevelopments": [
    ...
    },
    {
      "date": "2023",
      "title": "ユーロ導入",
      "description": "2023年1月ユーロ導入。医療機器の価格・手数料体系にも影響。"
    }
  ],
