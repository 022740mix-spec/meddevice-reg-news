...
export default {
  ...
  "primaryLaw": {
    ...
    "description": "中国の医療機器規制の最上位法規（国務院行政法規）。2021年の全面改正で、リスクベース規制の強化、登録人制度（MAH類似）の導入、臨床評価制度の整理、UDI制度の法的根拠整備、罰則強化などを実施。クラスI備案・クラスII/III登録の枠組みを規定。"
  },
  ...
  "recentDevelopments": [
    {
      ...
      "description": "NMPAがソフトウェア関連の医療機器規格（YY/T 1406-2026）を公布。医療機器ソフトウェアのライフサイクル管理に関する要件を更新。"
    },
    {
      "date": "2024-06",
